...
namespace U9SyncService.Model
{
    public class Dicts
    {
        ...
        new Company { CompanyNo = "101", Name = "牧童企业（清远）管理有限公司" },
        new Company { CompanyNo = "102", Name = "牧童（广东）投资中心（有限合伙）" },
        new Company { CompanyNo = "103", Name = "牧童控股（广东）有限公司" },
        new Company { CompanyNo = "110", Name = "广东智造乐园数据信息科技有限公司" },
        new Company { CompanyNo = "104", Name = "广州牧童水上乐园设备有限公司工会" },
        new Company { CompanyNo = "105", Name = "慕顿儿童游乐设备贸易有限责任公司" },
        ...
        new Company { CompanyNo = "113", Code = "C11", Name = "MOOTON GROUP INC（美国分公司）" },
